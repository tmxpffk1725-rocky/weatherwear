  ...
  properties: {
    presets: {
      ...
      items: {
        ...
        required: ['concept', 'reason', 'tip', 'top', 'bottom', 'outer', 'shoes', 'colors'],
      },
    },
  },
  required: ['presets'],
...
- 각 아이템의 색을 colors(top/bottom/outer/shoes)에 한국어 색 이름으로 명시하세요. 반드시 다음 12색 중에서만 고르세요: 블랙, 화이트, 그레이, 네이비, 베이지, 브라운, 카키, 블루, 그린, 레드, 핑크, 옐로우.
